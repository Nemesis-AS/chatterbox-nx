...
const Sidebar = () => {
  return (
    <>
      <aside className="hidden lg:flex flex-col gap-4 py-4 px-4 border-r border-zinc-600 max-w-64 w-full divide-y divide-zinc-600 overflow-y-auto max-h-[calc(100vh_-_80px)] custom-scrollbar fixed">
      ...
      <div className="hidden lg:flex flex-col gap-4 py-4 px-4 max-w-64 w-full"></div>
    </>
  );
};
